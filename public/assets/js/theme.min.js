        ...
        t.HSCore.components.HSDatatables = {
            ...
            init: function(e, a) {
                if (e.length) {
                    var s = Object.assign({}, this.defaults),
                        i = e.attr("data-hs-datatables-options") ? JSON.parse(e.attr("data-hs-datatables-options")) : {},
                        n = {};
                    n = t.extend(s, n, i, a);
                    var o = e.DataTable(n),
                        l = new t.fn.dataTable.Api(e),
                        r = function() {
                            var a = l.page.info(),
                                s = t("#" + l.context[0].nTable.id + "_paginate"),
                                i = s.find(".paginate_button.previous"),
                                o = s.find(".paginate_button.next"),
                                r = s.find(".paginate_button:not(.previous):not(.next), .ellipsis");
                            i.wrap('<span class="' + n.paginationItemsClasses + '"></span>'), i.addClass(n.paginationPrevLinkClasses).html(n.paginationPrevLinkMarkup), o.wrap('<span class="' + n.paginationItemsClasses + '"></span>'), o.addClass(n.paginationNextLinkClasses).html(n.paginationNextLinkMarkup), i.unwrap(i.parent()).wrap('<li class="paginate_item ' + n.paginationItemsClasses + '"></li>'), i.hasClass("disabled") && (i.removeClass("disabled"), i.parent().addClass("disabled")), o.unwrap(o.parent()).wrap('<li class="paginate_item ' + n.paginationItemsClasses + '"></li>'), o.hasClass("disabled") && (o.removeClass("disabled"), o.parent().addClass("disabled")), r.unwrap(r.parent()), r.each((function() {
                                t(this).hasClass("current") ? (t(this).removeClass("current"), t(this).wrap('<li class="paginate_item ' + n.paginationItemsClasses + ' active"></li>')) : t(this).wrap('<li class="paginate_item ' + n.paginationItemsClasses + '"></li>')
                            })), r.addClass(n.paginationLinksClasses), s.prepend('<ul id="' + l.context[0].nTable.id + '_pagination" class="' + n.paginationClasses + '"></ul>'), s.find(".paginate_item").appendTo("#" + l.context[0].nTable.id + "_pagination"), a.pages <= 1 ? t("#" + n.pagination).hide() : t("#" + n.pagination).show(), n.info.currentInterval && t(n.info.currentInterval).html(a.start + 1 + n.info.divider + a.end), n.info.totalQty && t(n.info.totalQty).html(a.recordsDisplay), n.scrollY && e.find(t(".dataTables_scrollBody thead tr")).css({
                                visibility: "hidden"
                            })
                        };
                    return r(), o.on("draw", r), this.customPagination(e, o, n), this.customSearch(e, o, n), n.isColumnsSearch && this.customColumnsSearch(e, o, n), this.customEntries(e, o, n), n.isSelectable && this.rowChecking(e), this.details(e, n.detailsInvoker, o), n.select && this.select(n.select, o), o
                }
            },
            ...
            customColumnsSearch: function(e, a, s) {
                ...
                a.columns().every((function() {
                    var e = this;
                    i.isColumnsSearchTheadAfter && t(".dataTables_scrollFoot").insertAfter(".dataTables_scrollHead"), t("input", this.footer()).on("keyup change", (function() {
                ...
                if (a) {
                    ...
                    t(e).on("click", a, (function() {
                        var e = t(this).closest("tr"),
                            a = s.row(e);
                        a.child.isShown() ? (a.child.hide(), e.removeClass("opened")) : (a.child(i.format(e.data("details"))).show(), e.addClass("opened"))
                    }))
                }
            },
            select: function(e, a) {
            ...
            init: function(e, a) {
                if (t(e).length) {
                    var s = t(e),
                        ...
                        n = s.attr("data-hs-clipboard-options") ? JSON.parse(s.attr("data-hs-clipboard-options")) : {},
                        o = {
                            shortcodes: {},
                    ...
                    o = t.extend(!0, i, n, o, a), n.contentTarget && this.setShortcodes(s, o);
                    var l = new ClipboardJS(e, o);
                    return l.on("success", (function() {
        ...
        t.HSCore.components.HSSelect2 = {
            ...
            init: function(e, a) {
                if (e.length) {
                    ...
                    o = t.extend(!0, i, o, n, a);
                    var l = e.select2(o);
                    return e.siblings(".select2").find(".select2-selection").removeClass("select2-selection--single").addClass(o.customClass), o.singleMultiple && (s.singleMultiple(e, o), l.on("select2:select", (function(t) {
                        s.singleMultiple(e, o)
                    })), l.on("select2:unselect", (function(t) {
                        s.singleMultiple(e, o)
                    }))), s.safariAutoWidth(l, o), s.leftOffset(l, o), s.dropdownWidth(l, o), o.searchInputPlaceholder && s.searchPlaceholder(l, o), l
                }
            },
            ...
            singleMultiple: function(e, a) {
                ...
                let i = t(e).next(".select2").find(".select2-selection"),
                    n = e.find(":selected").length > 0 ? s.singleMultiplePrefix + e.find(":selected").length + s.singleMultiplePostfix : s.placeholder;
                i.removeClass("select2-selection--multiple"), e.find(":selected").length > 0 ? i.addClass(s.singleMultipleActiveClass) : i.removeClass(s.singleMultipleActiveClass), i.find(".select2-selection__rendered").replaceWith('<span class="select2-selection__rendered" role="textbox" aria-readonly="true"><span class="select2-selection__placeholder">' + n + '</span></span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span>')
            },
            ...
            init: function(e, a) {
                if (e.length && void 0 !== e.attr("data-hs-mask-options")) {
                    var s = Object.assign({}, this.defaults),
                        ...
                        n = {};
                    return n = t.extend(!0, s, n, i, a), e.mask(n.template, n)
                }
            }
        }
    }(jQuery),
    function(t) {
        t.HSCore.components.HSPWStrength = {
            ...
            init: function(e, a) {
                if (e.length) {
                    var s = Object.assign({}, this.defaults),
                        i = e.attr("data-hs-pwstrength-options") ? JSON.parse(e.attr("data-hs-pwstrength-options")) : {},
                        n = {};
                    return n = t.extend(!0, s, n, i, a), e.pwstrength(n)
                }
            },
            methods: function(e) {
        ...
        t.HSCore.components.HSDropzone = {
            ...
            init: function(e, a) {
                if (e.length) {
                    var s = t(e),
                        i = Object.assign({}, this.defaults),
                        n = s.attr("data-hs-dropzone-options") ? JSON.parse(s.attr("data-hs-dropzone-options")) : {},
                        o = {
                            init: function() {
                                var e = this,
                    ...
                    return o = t.extend(!0, i, o, n, a), new Dropzone(e, o)
                }
            }
        }
    }(jQuery),
    function(t) {
        t.HSCore.components.HSFlatpickr = {
            ...
            init: function(e, a) {
                if (e.length) {
                    var s = Object.assign({}, this.defaults),
                        i = e.attr("data-hs-flatpickr-options") ? JSON.parse(e.attr("data-hs-flatpickr-options")) : {},
                        n = {};
                    n = t.extend(!0, s, n, i, {
                        appendTo: i ? t(i.appendTo)[0] : this
                    }, a);
                    var o = e.flatpickr(n);
                    return e.css({
    ...
    function(t) {
        t.HSCore.components.HSSortable = {
            ...
            init: function(e, a) {
                if (e.length) {
                    var s = Object.assign({}, this.defaults),
                        i = e.attr("data-hs-sortable-options") ? JSON.parse(e.attr("data-hs-sortable-options")) : {},
                        n = {};
                    return n = t.extend(!0, s, n, i, a), new Sortable(e[0], n)
                }
            }
        }
    }(jQuery),
        ...
        t.HSCore.components.HSValidation = {
            ...
            init: function(e, a) {
                if (e.length) {
                    ...
                    n = t.extend(!0, s, n, i, a), e.hasClass("js-step-form") ? t.validator.setDefaults({
            ...
            highlight: function(e) {
                var a = t(e),
                    ...
                    i = a.data("success-class") ? a.data("error-class") : "is-valid",
                    n = a.parents(".js-form-message").first(),
                    o = a;
                void 0 !== n.data("validate-state") ? o = n : n.find("[data-validate-state]").length && (o = n.find("[data-validate-state]")), o.removeClass(i).addClass(s)
            },
            unHighlight: function(e) {
                var a = t(e),
                    ...
                    n = a.parents(".js-form-message").first(),
                    o = a;
                void 0 !== n.data("validate-state") ? o = n : n.find("[data-validate-state]").length && (o = n.find("[data-validate-state]")), o.removeClass(s).addClass(i)
            },
            ...
            init: function(e, a) {
                if (e.length) {
                    var s = Object.assign({}, this.defaults),
                        ...
                        n = {};
                    n = t.extend(!0, i.type, s, "line" === i.type ? {
                        options: {
                            scales: {
                                yAxes: [{
                                    ticks: {
                                        callback: function(t, e, a) {
                                            var s = n.options.scales.yAxes[0].ticks.metric,
                                                i = n.options.scales.yAxes[0].ticks.prefix,
                                                o = n.options.scales.yAxes[0].ticks.postfix;
                                            return s && t > 100 && (t = t < 1e6 ? t / 1e3 + "k" : t / 1e6 + "kk"), i ? i + t : o ? t + o : t
                                        }
                                    }
                                }]
                            },
                                ...
                                custom: function(t) {
                                    ...
                                    if (a.classList.remove("above", "below", "no-transform"), t.yAlign ? a.classList.add(t.yAlign) : a.classList.add("no-transform"), t.body) {
                                        var s = t.title || [],
                                            ...
                                            o = new Date,
                                            l = '<header class="hs-chartjs-tooltip-header">';
                                        s.forEach((function(t) {
                                            l += t + ", " + o.getFullYear()
                                        })), l += '</header><div class="hs-chartjs-tooltip-body">', i.forEach((function(e, a) {
                                            l += "<div>";
                                            var s = e[0],
                                                i = s,
                                                o = t.labelColors[a].backgroundColor instanceof Object ? t.labelColors[a].borderColor : t.labelColors[a].backgroundColor;
                                            l += (n.options.tooltips.hasIndicator ? '<span class="d-inline-block rounded-circle mr-1" style="width: ' + n.options.tooltips.indicatorWidth + "; height: " + n.options.tooltips.indicatorHeight + "; background-color: " + o + '"></span>' : "") + n.options.tooltips.prefix + (s.length > 3 ? i : e) + n.options.tooltips.postfix, l += "</div>"
                                        })), l += "</div>", a.querySelector(".hs-chartjs-tooltip").innerHTML = l
                                    }
                                    var r = this._chart.canvas.getBoundingClientRect();
                                    a.style.opacity = 1, n.options.tooltips.lineMode ? a.style.left = t.caretX + "px" : a.style.left = r.left + window.pageXOffset + t.caretX - a.offsetWidth / 2 - 3 + "px", a.style.top = r.top + window.pageYOffset + t.caretY - a.offsetHeight - 25 + "px", a.style.pointerEvents = "none", a.style.transition = n.options.tooltips.transition
                                }
                            }
                        }
                    }, i, n, a)).type && n.data.datasets.forEach((function(t) {
                        if (Array.isArray(t.backgroundColor)) {
                            var a = e[0].getContext("2d").createLinearGradient(n.options.gradientPosition.x0, n.options.gradientPosition.y0, n.options.gradientPosition.x1, n.options.gradientPosition.y1);
                    ...
                    if ("line" === n.type && n.options.tooltips.lineMode) {
                        var l = o.draw;
                        o.draw = function(e) {
                            if (l.call(this, e), this.chart.tooltip._active && this.chart.tooltip._active.length) {
                                ...
                                var a = t(this.chart.canvas),
                                    ...
                                    r = n.options.tooltips.lineWithLineBottomOffset >= 0 ? n.options.tooltips.lineWithLineBottomOffset : 43;
                                ...
                                }), s.offset().left + s.width() > a.offset().left + a.width() - 100 ? t(".hs-chartjs-tooltip").removeClass("hs-chartjs-tooltip-right").addClass("hs-chartjs-tooltip-left") : t(".hs-chartjs-tooltip").addClass("hs-chartjs-tooltip-right").removeClass("hs-chartjs-tooltip-left"), i.length && i.css({
                                    position: "absolute",
                                    width: "2px",
                                    height: a.height() - r,
    ...
    function(t) {
        t.HSCore.components.HSJVectorMap = {
            ...
            init: function(e, a) {
                if (e.length) {
                    var s = Object.assign({}, this.defaults),
                        i = e.attr("data-hs-jvector-map-options") ? JSON.parse(e.attr("data-hs-jvector-map-options")) : {},
                        n = {};
                    (n = t.extend(!0, s, i, n, a)).container = e;
                    var o = new jvm.Map(n);
                    return n.tipCentered ? this.tipCentered(o.tip) : this.fixTipPosition(o.tip), o
                }
            },
        ...
        t.HSCore.components.HSQuill = {
            ...
            init: function(e, a) {
                if (t(e).length) {
                    var s = t(e),
                        i = Object.assign({}, this.defaults),
                        n = s.attr("data-hs-quill-options") ? JSON.parse(s.attr("data-hs-quill-options")) : {},
                        o = {};
                    o = Object.assign({}, i, o, n, a);
                    var l = new Quill(e, o);
                    return this.toolbarBottom(l, o), l
                }
            },
            toolbarBottom: function(e, a) {
                if (a.toolbarBottom) {
                    let s = t(e.container),
                        i = t(e.container).prev(".ql-toolbar");
                    s.parent().addClass("ql-toolbar-bottom"), a.attach ? t(a.attach).on("shown.bs.modal", (function(t) {
                        s.css({
                            paddingBottom: i.innerHeight()
                        })
                    })) : s.css({
                        paddingBottom: i.innerHeight()
                    }), i.css({
    ...
    function(t) {
        t.HSCore.components.HSTagify = {
            ...
            init: function(e, a) {
                if (e.length) {
                    var s = Object.assign({}, this.defaults),
                        i = e.attr("data-hs-tagify-options") ? JSON.parse(e.attr("data-hs-tagify-options")) : {},
                        n = {};
                    n = t.extend(!0, s, n, i, a);
                    var o = new Tagify(e[0], n);
                    return t(n.clearBtnSelector).on("click", o.removeAllTags.bind(o)), n.hasManualList && (this._renderSuggestionsList(e, o), e.on("add", (function() {
        ...
        t.HSCore.components.HSCircles = {
            ...
            init: function(e, a) {
                if (e.length) {
                    ...
                    (n = t.extend(s, n, i, a)).isViewportInit && (n.value = 0), this.setId(e, n.id);
                    var o = Circles.create(n);
                    return e.data("circle", o), this.setTextStyles(e, o, n), n.rtl && this.setRtl(e), n.fgStrokeLinecap && this.setStrokeLineCap(e, o, n), n.fgStrokeMiterlimit && this.setStrokeMiterLimit(e, o, n), n.isViewportInit && this.initAppear(o, n), o
                }
            },
            setId: function(t, e) {
                t.attr("id", e)
            ...
            init: function(e, a) {
                if (t(e).length) {
                    var s = this,
                        ...
                        o = i.attr("data-hs-list-options") ? JSON.parse(i.attr("data-hs-list-options")) : {},
                        l = {};
                    l = t.extend(!0, n, l, o, a);
                    var r = new List(i.attr("id"), l, l.values);
                    return l.searchMenu && t(r.list).fadeOut(0), r.on("searchComplete", (function() {
                        l.searchMenu && (s.searchMenu(i, l, r), s.searchMenuHide(i, l, r)), !l.searchMenu && l.empty && s.emptyBlock(i, l, r)
                    })), l.searchMenu && l.keyboard && s.initializeHover(i, l, r), r
                }
            },
            initializeHover: function(e, a, s) {
                var i, n = s,
                    o = (t(n.list).find(".list-group-item"), e.find("." + n.searchClass));
                t(o).keydown((function(e) {
                    if (40 === e.which) {
                        if (e.preventDefault(), 0 == t(n.list).children(".active").length) i = t(n.list).children().first().addClass("active");
                        else if (t(n.list).children(".active").next().length) {
                            var a = t(n.list).children(".active").next().addClass("active");
                            t(i).removeClass("active"), i = a, t(n.list).height() < t(n.list).children(".active").position().top && t(n.list).scrollTop(t(n.list).children(".active").position().top + t(n.list).scrollTop())
                        }
                    } else if (38 === e.which) {
                        if (e.preventDefault(), 0 == t(n.list).children(".active").length) i = t(n.list).children().first().parent().addClass("active");
                        else if (t(n.list).children(".active").prev().length) {
                            a = t(n.list).children(".active").prev().addClass("active");
                            t(i).removeClass("active"), i = a, 0 > t(n.list).children(".active").position().top && t(n.list).scrollTop(t(n.list).children(".active").position().top + t(n.list).scrollTop())
                        }
                    } else 13 == e.which && o.val().length > 0 && (e.preventDefault(), window.location.replace(t(i).find("a").first().attr("href")))
                }))
            },
            searchMenu: function(e, a, s) {
                var i = a,
                    n = s;
                if (0 === e.find("." + n.searchClass).val().length || 0 === n.visibleItems.length && !i.empty) t(i.empty).fadeOut(0), t(n.list).fadeOut(i.searchMenuDelay);
                else if (t(n.list).fadeIn(i.searchMenuDelay), !n.visibleItems.length) {
                    var o = t(i.empty).clone();
                    t(n.list).html(o), t(o).fadeIn(0)
                }
            },
            searchMenuHide: function(e, a, s) {
                var i = a,
                    n = s,
                    o = e.find("." + n.searchClass);
                i.searchMenuOutsideClose && t(window).click((function() {
                    t(n.list).fadeOut(i.searchMenuDelay), i.clearSearchInput && o.val("")
                })), i.searchMenuInsideClose || t(n.list).click((function(t) {
                    t.stopPropagation(), i.clearSearchInput && o.val("")
                }))
            },
            emptyBlock: function(e, a, s) {
                var i = a,
                    n = s;
                if (0 === e.find("." + n.searchClass).val().length || 0 === n.visibleItems.length && !i.empty) t(i.empty).fadeOut(0);
                else if (t(n.list).fadeIn(i.searchMenuDelay), !n.visibleItems.length) {
                    var o = t(i.empty).clone();
                    t(n.list).html(o), t(o).fadeIn(0)
                }
            ...
            init: function(e, a, s) {
                if (e.length) {
                    var i = Object.assign({}, this.defaults),
                        n = e.attr("data-hs-daterangepicker-options") ? JSON.parse(e.attr("data-hs-daterangepicker-options")) : {},
                        o = {};
                    return o = t.extend(!0, i, n, o, a, s), e.daterangepicker(o, s)
                }
            }
        }
    }(jQuery),
                    ...
                    var s = Object.assign({}, this.defaults),
                        ...
                        n = {
                            onStart: function(e) {
                                ...
                                if (n.result_min_target_el && "single" === n.type ? t(n.result_min_target_el).is("input") ? t(n.result_min_target_el).val(e.from) : t(n.result_min_target_el).text(e.from) : (n.result_min_target_el || n.result_max_target_el && "double" === n.type) && (t(n.result_min_target_el).is("input") ? t(n.result_min_target_el).val(e.from) : t(n.result_min_target_el).text(e.from), t(n.result_min_target_el).is("input") ? t(n.result_max_target_el).val(e.to) : t(n.result_max_target_el).text(e.to)), n.grid && "single" === n.type && t(e.slider).find(".irs-grid-text").each((function(a) {
                                        var s = t(this);
                                        t(s).text() === e.from && (t(e.slider).find(".irs-grid-text").removeClass("current"), t(s).addClass("current"))
                                    })), n.secondary_target_el) {
                                    n.secondary_val.steps.push(e.max + 1), n.secondary_val.values.push(n.secondary_val.values[n.secondary_val.values.length - 1] + 1);
                                    for (var s = 0; s < n.secondary_val.steps.length; s++) e.from >= n.secondary_val.steps[s] && e.from < n.secondary_val.steps[s + 1] && (t(n.secondary_target_el).is("input") ? t(n.secondary_target_el).val(n.secondary_val.values[s]) : t(n.secondary_target_el).text(n.secondary_val.values[s]))
                                }
                            },
                            onChange: function(e) {
                                if (n.foreground_target_el) {
                                ...
                                if (n.result_min_target_el && "single" === n.type ? t(n.result_min_target_el).is("input") ? t(n.result_min_target_el).val(e.from) : t(n.result_min_target_el).text(e.from) : (n.result_min_target_el || n.result_max_target_el && "double" === n.type) && (t(n.result_min_target_el).is("input") ? t(n.result_min_target_el).val(e.from) : t(n.result_min_target_el).text(e.from), t(n.result_min_target_el).is("input") ? t(n.result_max_target_el).val(e.to) : t(n.result_max_target_el).text(e.to)), n.grid && "single" === n.type && t(e.slider).find(".irs-grid-text").each((function(a) {
                                    ...
                                    for (var i = 0; i < n.secondary_val.steps.length; i++) e.from >= n.secondary_val.steps[i] && e.from < n.secondary_val.steps[i + 1] && (t(n.secondary_target_el).is("input") ? t(n.secondary_target_el).val(n.secondary_val.values[i]) : t(n.secondary_target_el).text(n.secondary_val.values[i]));
                                a && a.cusOnChange && "function" == typeof a.cusOnChange && a.cusOnChange()
                            }
                        };
                    n = t.extend(!0, s, n, i, a);
                    var o = e.ionRangeSlider(n),
                        l = e.data("ionRangeSlider");
    ...
    function(t) {
        t.HSCore.components.HSLeaflet = {
            ...
            init: function(e, a) {
                if (t(e).length) {
                    var s = t(e),
                        i = s.attr("data-hs-leaflet-options") ? JSON.parse(s.attr("data-hs-leaflet-options")) : {},
                        n = {};
                    n = t.extend(!0, this.defaults, i, n, a);
                    var o = L.map(e, n.map);
                    if (o.setView(n.map.coords, n.map.zoom), L.tileLayer(n.layer.token, n.layer).addTo(o), n.marker)
                        for (var l = 0; l < n.marker.length; l++) {
                            n.marker[l].icon = L.icon(n.marker[l].icon);
                            let t = L.marker(n.marker[l].coords, n.marker[l]).addTo(o);
                            n.marker[l].popup && t.bindPopup(n.marker[l].popup.text)
                        }
                    return o
                }
            }
